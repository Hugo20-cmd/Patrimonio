  ...
  return (
    ...
    >
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))", gap: "16px" }}>
        ...
        <div className="metric-card">
          <div style={{ fontSize: "0.75rem", color: "var(--text-tertiary)", textTransform: "uppercase", letterSpacing: "0.05em", marginBottom: "4px" }}>Saldo Lí­quido</div>
      ...
      <div style={{
        ...
        <div style={{ padding: "20px 24px", borderBottom: "1px solid var(--border-subtle)", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <h3 style={{ fontSize: "1.1rem" }}>Histí³rico</h3>
          ...
          <table className="table-premium" style={{ minWidth: "100%" }}>
            <thead>
              <tr>
                ...
                <th style={{ textAlign: "right", paddingRight: "24px" }}>Açíµes</th>
              </tr>
            </thead>
            <tbody>
      ...
      <AnimatePresence>
        {toastInfo && (
          ...
          >
            <div style={{ fontSize: "1.2rem", fontWeight: 800 }}>ð Sucesso!</div>
            <div style={{ fontSize: "0.95rem" }}>
              Vocíª ganhou <strong>+{toastInfo.xp} XP</strong> por investir!
            </div>
            {toastInfo.achievements > 0 && (
              <div style={{ fontSize: "0.9rem", background: "rgba(255,255,255,0.2)", padding: "8px 12px", borderRadius: "8px", marginTop: "4px", fontWeight: 600 }}>
                ð {toastInfo.achievements} Nova{toastInfo.achievements > 1 ? 's' : ''} Conquista{toastInfo.achievements > 1 ? 's' : ''} Desbloqueada{toastInfo.achievements > 1 ? 's' : ''}!
              </div>
            )}
          </motion.div>
        )}

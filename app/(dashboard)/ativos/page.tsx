...
const MACRO_DATA = [
  { label: "Dí­Â³lar Comercial", value: "R$ 5,06", desc: "Moeda forte mundial. Protege seu patrimônio contra a inflação local e crises." },
  ...
  { label: "Euro", value: "R$ 5,45", desc: "A moeda oficial de 20 paí­Â­ses da Europa. Forte reserva de valor." }
];
...
const EDUCATIONAL_COLLECTIONS = [
  {
    ...
    description: "ETFs que compram dezenas de empresas de uma vez sí­Â³. O jeito mais fácil, barato e seguro de começar a investir sem ter que escolher.",
    icon: <ShieldCheck size={24} color="var(--green-primary)" />,
    assets: [
      { ticker: "BOVA11", name: "iShares Ibovespa", reason: "Compra as 80 maiores empresas do Brasil de uma sí­Â³ vez.", tags: ["Brasil", "Diversificado"], fundamentals: { var12m: "+12,5%" } },
      { ticker: "IVVB11", name: "iShares S&P 500", reason: "Investe nas 500 maiores empresas dos Estados Unidos. Proteção em dí­Â³lar.", tags: ["EUA", "Dí­Â³lar"], fundamentals: { var12m: "+24,1%" } },
    ]
  },
  {
    id: "renda",
    title: "Construindo Renda (Imí­Â³veis e Dividendos)",
    description: "Ativos focados em te pagar dinheiro limpo na conta todo mí­Âªs (como se fossem aluguéis).",
    ...
    assets: [
      ...
      { ticker: "HGLG11", name: "CSHG Logí­Â­stica", reason: "Dono de galpí­Âµes logí­Â­sticos alugados para grandes empresas no Brasil.", tags: ["FII", "Imí­Â³veis"], fundamentals: { dy: "9,1%", pvp: "0,95", var12m: "+8,7%" } },
      { ticker: "BBAS3", name: "Banco do Brasil", reason: "Banco sí­Â³lido famoso por distribuir í­Â³timos lucros aos sí­Â³cios.", tags: ["Ação", "Dividendos"], fundamentals: { dy: "11,2%", pvp: "0,88", var12m: "+18,5%" } }
    ]
  },
  {
    id: "reits",
    title: "REITs (Imí­Â³veis em Dí­Â³lar)",
    description: "Receba 'aluguéis' em dí­Â³lar investindo nos maiores galpí­Âµes, shoppings e hospitais dos Estados Unidos.",
    icon: <MapPin size={24} color="#ff8c00" />,
    assets: [
      { ticker: "O", name: "Realty Income", reason: "Conhecido como 'The Monthly Dividend Company', paga dividendos todo mí­Âªs nos EUA.", tags: ["REIT", "Mensal"], fundamentals: { dy: "5,8%", pvp: "1,41", var12m: "+13,8%" } },
      { ticker: "PLD", name: "Prologis", reason: "Lí­Â­der global em galpí­Âµes logí­Â­sticos, alugando espaço para gigantes como Amazon.", tags: ["REIT", "Logí­Â­stica"], fundamentals: { dy: "2,8%", pvp: "2,29", var12m: "+36,6%" } }
    ]
  },
  {
    id: "tecnologia",
    title: "Gigantes Globais (Crescimento)",
    description: "Seja sí­Â³cio das empresas que estão dominando a inteligí­Âªncia artificial e a internet.",
    ...
    assets: [
      ...
      { ticker: "NVDA", name: "Nvidia Corp.", reason: "A rainha da inteligí­Âªncia artificial. Fabrica os chips mais procurados do mundo.", tags: ["Ação EUA", "IA"], fundamentals: { mcap: "US$ 2.8T", var12m: "+210%" } },
    ]
  },
  {
    id: "cripto",
    title: "Criptomoedas (A Nova Economia)",
    description: "Ativos digitais descentralizados. Altí­Â­ssimo potencial de crescimento, mas com altí­Â­ssima volatilidade.",
  ...
  const handleAddAsset = async (e: React.MouseEvent, assetTicker: string) => {
    ...
    try {
      ...
      if (res.error) alert(res.error);
        ...
        alert(`${assetTicker} adicionado í­Â  sua carteira com sucesso!`);
      }
    } catch (err) {
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "16px", marginBottom: "40px", background: "var(--bg-card)", padding: "32px", borderRadius: "24px", border: "1px solid var(--border-default)" }}>
        ...
        <form onSubmit={handleSearch} style={{ display: "flex", gap: "12px", width: "100%", maxWidth: "500px", marginTop: "8px" }}>
          <div style={{ position: "relative", flex: 1 }}>
            ...
            <input
              type="text"
              placeholder="Buscar um ticker especí­Â­fico (ex: PETR4, NVDA)..."
              value={ticker}
                ...
                >
                  ...
                  <div style={{ display: "flex", gap: "16px", marginBottom: "16px", background: "var(--bg-elevated)", padding: "12px", borderRadius: "12px", border: "1px solid var(--border-subtle)" }}>
                    {asset.fundamentals.dy && (
                      <EduTooltip title="DY" text="Dividend Yield: A porcentagem que este ativo te devolveu em formato de lucro/aluguel nos í­Âºltimos 12 meses. Dinheiro no seu bolso." value={asset.fundamentals.dy} />
                    )}
                    ...
                    {asset.fundamentals.var12m && (
                      <EduTooltip title="Variação (1A)" text="O quanto a cotação (preço do ativo) subiu ou caiu no perí­Â­odo de 1 ano." value={asset.fundamentals.var12m} />
                    )}
                  </div>

  ...
  return (
    ...
    >
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", flexWrap: "wrap", gap: "16px" }}>
        <div>
          <h1 style={{ fontSize: "1.8rem", marginBottom: "4px" }}>Hub de Informaçíµes</h1>
          <p style={{ color: "var(--text-tertiary)", fontSize: "0.9rem" }}>Notí­cias do mercado atualizadas em tempo real para assinantes.</p>
        </div>
      </div>

...
import { 
  mockPatrimonioHistory, mockAssets, calcPortfolioMetrics, 
  formatCurrency, formatPercent, formatCompact,
  assetTypeColor, assetTypeLabel
} from "@/lib/mock-data";
...
export default function DashboardPage() {
  ...
  // Top Assets
  const topAssets = [...mockAssets].sort((a, b) => (b.quantity * b.currentPrice) - (a.quantity * a.currentPrice)).slice(0, 5);
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))", gap: "16px" }}>
        ...
        <div className="metric-card">
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "12px" }}>
            ...
            <span style={{ fontSize: "0.8rem", fontWeight: 600, color: "var(--green-primary)" }}>+14% vs. Mês Ant.</span>
          </div>
        ...
        <div style={{
          ...
          <div style={{ height: "300px", marginLeft: "-16px" }}>
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={mockPatrimonioHistory}>
                <defs>

    ...
    >
      ...
      <div style={{ display: "flex", gap: "12px", marginBottom: "24px" }}>
        ...
        >
          ...
          <div style={{ fontSize: "1.2rem", fontWeight: 800, color: "var(--text-primary)" }}>R$ 19,99<span style={{ fontSize: "0.7rem", color: "var(--text-tertiary)" }}>/míªs</span></div>
        </div>
      </div>
      ...
      <p style={{ textAlign: "center", marginTop: "20px", fontSize: "0.78rem", color: "var(--text-tertiary)", lineHeight: 1.6 }}>
        Ao se registrar, vocíª concorda com nossos{" "}
...
export default function RegisterPage() {
  return (
    <div style={{
      ...
      {/* Left panel â illustration (hidden on mobile) */}
      <div style={{
        flex: 1,

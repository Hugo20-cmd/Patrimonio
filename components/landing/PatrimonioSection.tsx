      ...
      <div className="container" style={{ position: "relative", zIndex: 1 }}>
        ...
        >
          ...
          <p style={{ fontSize: "1.05rem", maxWidth: "520px", margin: "0 auto" }}>
            Gráficos detalhados que mostram a evolução real do seu portfí³lio, investimentos realizados e renda passiva gerada.
          </p>
        </motion.div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1.6fr 1fr", gap: "24px" }} className="charts-grid">
          ...
          >
            ...
            <div style={{
              ...
              <div>
                <div style={{ fontSize: "0.8rem", fontWeight: 600, color: "var(--text-primary)" }}>Prí³ximo dividendo</div>
                <div style={{ fontSize: "0.75rem", color: "var(--green-primary)", fontWeight: 600 }}>MXRF11 â R$ 527,50 em 14/Jun</div>
              </div>
            </div>
          </motion.div>
        </div>
